	...
	<div class="row">
		...
		<div class="wrap">
			...
			<div class="contact-header">
				...
				<a href="<?php echo get_page_link(46); ?>" style="color:white;text-decoration: none;"><button type="button" id="license-inquire">INQUIRE</button></a>

					<a href="<?php echo get_page_link(14); ?>" style="color:white;text-decoration: none;"><button type="button" id="license-upload">UPLOAD LICENSE</button></a>
