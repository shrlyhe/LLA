	...
	<div class="row">
		...
		<div class="col-sm-4 job">
			...
			<div class="services-buttons">
				...
				<a href="<?php echo get_page_link(); ?>" style="color:white"><button type="button" class="specific">General Audience</button></a>

				<a href="<?php echo get_page_link(); ?>" style="color:white"><button type="button" class="specific">Lawyers</button></a>
				...
				<a href="<?php echo get_page_link(); ?>" style="color:white"><button type="button" class="specific">Food & Beverage Establishment Owners</button></a>

				<a href="<?php echo get_page_link(); ?>" style="color:white"><button type="button" class="specific">Lenders</button></a>
